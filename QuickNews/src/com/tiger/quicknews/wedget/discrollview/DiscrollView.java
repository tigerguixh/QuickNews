...
/**
 * Layout container for a View hierarchy that can discrollved (ie
 * Discrollvable). For each discrollvables, if it's possible (ie enough space to
 * scroll the whole view), the discrollvable starts to be discrollved when its
 * center reaches the center of the DiscrollView; else, the discrollvables
 * starts to be discrollved when its top reaches the bottom of the DiscrollView
 * 
