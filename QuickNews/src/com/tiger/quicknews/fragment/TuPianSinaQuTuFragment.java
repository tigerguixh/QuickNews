...
public class TuPianSinaQuTuFragment extends BaseFragment implements
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity()
                    .getCacheStr("TuPianSinaQuTuFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("TuPianSinaQuTuFragment" + currentPagte, result);
        if (isRefresh) {
            isRefresh = false;
            photoAdapter.clear();
            listsModles.clear();
