...
public class FangChanFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity().getCacheStr("FangChanFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("FangChanFragment" + currentPagte, result);
        if (isRefresh) {
            isRefresh = false;
            newAdapter.clear();
            listsModles.clear();
