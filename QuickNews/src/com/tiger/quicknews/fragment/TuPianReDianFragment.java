...
public class TuPianReDianFragment extends BaseFragment implements
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity().getCacheStr("TuPianReDianFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("TuPianReDianFragment" + currentPagte, result);
        if (isRefresh) {
            isRefresh = false;
            photoAdapter.clear();
            listsModles.clear();
