...
public class BeiJingFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity().getCacheStr("BeiJingFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("BeiJingFragment" + currentPagte, result);
        if (isRefresh) {
            isRefresh = false;
            newAdapter.clear();
            listsModles.clear();
