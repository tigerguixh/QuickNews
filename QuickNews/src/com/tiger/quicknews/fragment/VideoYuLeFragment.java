...
public class VideoYuLeFragment extends BaseFragment implements
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity().getCacheStr("VideoYuLeFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("VideoYuLeFragment" + currentPagte, result);
        if (isRefresh) {
            isRefresh = false;
            videoAdapter.clear();
            listsModles.clear();
