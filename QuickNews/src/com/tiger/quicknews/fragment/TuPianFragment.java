...
public class TuPianFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void init() {
        ...
        if (count != -1) {
            ...
            indexId = 43374;
            PreferencesUtils.putLong(getActivity(), "lastupdatetime", System.currentTimeMillis());
    ...
    private void loadData(String url) {
        if (getMyActivity().hasNetWork()) {
            ...
            String result = getMyActivity().getCacheStr("TuPianFragment" + currentPagte);
    ...
    public void getResult(String result) {
        getMyActivity().setCacheStr("TuPianFragment" + currentPagte, result);
        try {
            if (isRefresh) {
                isRefresh = false;
                photoAdapter.clear();
